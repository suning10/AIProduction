...
class GroupResponse(BaseResponse):
    ...
    id: int = Field(..., description="The group's ID")
    name: str = Field(..., description="The group's name")
    role: str = Field(..., description="The requesting user's role in this group")
...
class GroupMemberAdd(BaseModel):
    ...
    role: str = Field(default="member", description="Role to grant: 'admin' or 'member'")
...
class SearchRequest(BaseModel):
    ...
    group_id: Optional[int] = Field(default=None, description="Restrict search to a single group")
